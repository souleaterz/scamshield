...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    { url: `${SITE_URL}/c/domain`, lastModified: now, changeFrequency: "daily", priority: 0.7 },
    { url: `${SITE_URL}/c/phone`, lastModified: now, changeFrequency: "daily", priority: 0.7 },
    { url: `${SITE_URL}/c/company`, lastModified: now, changeFrequency: "daily", priority: 0.7 },
